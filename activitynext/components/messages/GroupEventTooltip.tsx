...
interface GroupEventTooltipProps {
  ...
  eventCount: number;
  isVisible: boolean;
  onClose?: () => void; // 🆕 Valgfri close handler
}
...
export default function GroupEventTooltip({
  ...
  return (
    <div 
      className="bg-[#2e2e2e] dark:bg-gray-[#2e2e2e] border border-[#1C6B1C] dark:border-[#1C6B1C] rounded-lg shadow-lg p-3 min-w-[250px] max-w-[400px]"
