...
public interface IIpBanService
{
    ...
    Task HandleSuspiciousActivityEscalationAsync(AppDbContext context, string ipAddress,
    ...
    Task<int> GetRecentSuspiciousCountAsync(AppDbContext context, string? ipAddress, string? deviceId);
