...
public class FriendInvitationDTO
{
    ...
    public SenderDTO Sender { get; set; } = null!; // Henter brukerid, navn og bilde fra brukeren, men istedenfor å sende alt til brukeren så sender vi kun det vi spesifiser i SenderDTO.cs
