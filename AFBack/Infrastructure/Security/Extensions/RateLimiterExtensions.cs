...
namespace AFBack.Infrastructure.Security.Extensions;
...
public static class RateLimiterExtensions
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {   
            ...
            // Henter ut brukerId logging og opprettelse av Suspicious Activites
            var deviceInfo = isMobile ? " Mobile" : " Web";
            ...
            {
                var suspiciousActivityService = httpContext.RequestServices.GetService<ISuspiciousActivityService>();
                if (suspiciousActivityService != null)
                {
                    // Henter fingerprint for device-oppslag i IpBanService
                    var fingerprint = isMobile
                        ? FingerprintUtils.GetMobileDeviceFingerprint(httpContext)
                        : FingerprintUtils.GetWebFingerprint(httpContext);
