...
namespace AFBack.Migrations
{
    ...
    [Migration("20250625092208_AddGroupEventsAndNotifications")]
    partial class AddGroupEventsAndNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AFBack.Models.GroupNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("GroupEventIdsJson")
                        .IsRequired()
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)");
                    ...
                    b.HasIndex("UserId", "ConversationId", "IsRead")
                        .IsUnique()
                        .HasFilter("\"IsRead\" = false");

                    b.HasIndex("UserId", "IsRead", "LastUpdatedAt");
