        ...
        try
        {
            ...
            foreach (var fileData in request.EncryptedFilesData)
            {
                ...
                var encryptedAttachment = new EncryptedAttachmentDto
                {
                    ...
                    ThumbnailKeyInfo = fileData.ThumbnailKeyInfo != null 
                        ? JsonSerializer.Serialize(fileData.ThumbnailKeyInfo) 
                        : null,
            ...
            var thumbnailCount = encryptedAttachments.Count(a => !string.IsNullOrEmpty(a.ThumbnailUrl));
            return Ok(new
            {
                ...
                attachments = encryptedAttachments.Select(a => new {
                    ...
                    hasThumbnail = !string.IsNullOrEmpty(a.ThumbnailUrl),
