    ...
    IUserSummaryCacheService userSummariesCache) : IGetConversationsService
{
         ...
         CancellationToken ct = default)
    {
        ...
        var conversationDto = await conversationRepository.GetConversationDtoAsync(conversationId, ct);
        ...
        if (conversationDto == null)
        {
            ...
            return Result<ConversationResponse>.Failure("No conversation found", AppErrorCode.NotFound);
        }
        ...
        if (!userIds.Contains(userId))
        {
            ...
            return Result<ConversationResponse>.Failure("No conversation found", AppErrorCode.Forbidden);
        }
    ...
    public async Task<Result<ConversationsResponse>> GetActiveConversationsAsync(
        string userId, PaginationRequest request, CancellationToken ct = default)
    {
        ...
        return await GetConversationsInternalAsync(
            ...
            conversationRepository.GetActiveConversationsAsync, ct);
    }
        ...
        string userId, PaginationRequest request, CancellationToken ct = default)
    {
        ...
        return await GetConversationsInternalAsync(userId, request,
            ...
            conversationRepository.GetPendingConversationsAsync, ct);
    }
        ...
        string userId, PaginationRequest request, CancellationToken ct = default)
    {
        ...
        return await GetConversationsInternalAsync(
            ...
            conversationRepository.GetArchivedConversationsAsync, ct);
    }
        ...
        string userId, PaginationRequest request, CancellationToken ct = default)
    {
        ...
        return await GetConversationsInternalAsync(userId, request,
            ...
            conversationRepository.GetRejectedConversationsAsync, ct);
    }
    ...
    private async Task<Result<ConversationsResponse>> GetConversationsInternalAsync(
        ...
        Func<string, CancellationToken, Task<int>> getCountAsync,
        Func<string, int, int, CancellationToken, Task<List<ConversationDto>>> getConversationsAsync,
        CancellationToken ct = default)
    {
        // Teller antall samtaler vi skal hente
        var totalCount = await getCountAsync(userId, ct);
