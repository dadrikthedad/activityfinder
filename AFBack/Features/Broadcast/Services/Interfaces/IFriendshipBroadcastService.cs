...
public interface IFriendshipBroadcastService
{
    ...
    /// <summary>
    /// Broadcaster at et vennskap ble fjernet.
    /// Sender SyncEvent til begge parter og stille SignalR til vennen.
    /// Ingen notification — vennen ser bare at brukeren forsvinner fra listen.
    /// </summary>
    /// <param name="userId">Brukeren som fjerner vennskapet</param>
    /// <param name="friendId">Vennen som blir fjernet</param>
    Task BroadcastFriendshipRemovedAsync(string userId, string friendId);
}
